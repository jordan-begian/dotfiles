...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/home/jordan/dotfiles/opencode/.config/opencode/context/` (direct path references)
    - `@/home/jordan/dotfiles/opencode/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /home/jordan/dotfiles/opencode/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /home/jordan/dotfiles/opencode/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /home/jordan/dotfiles/opencode/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/home/jordan/dotfiles/opencode/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/home/jordan/dotfiles/opencode/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/home/jordan/dotfiles/opencode/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/home/jordan/dotfiles/opencode/.config/opencode/context/core/" (direct paths)
       - "@/home/jordan/dotfiles/opencode/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /home/jordan/dotfiles/opencode/.config/opencode/context/core/:
...
✓ /home/jordan/dotfiles/opencode/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /home/jordan/dotfiles/opencode/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/home/jordan/dotfiles/opencode/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
